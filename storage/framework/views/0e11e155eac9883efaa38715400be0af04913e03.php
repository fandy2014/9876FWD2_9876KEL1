		...
		<?php endif; ?>
			...
			<div class="privacy-question">
				...
				<fieldset class="form-group required <?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
					...
					<?php if($mode == "create"): ?>
						<?php echo e(Form::textarea('description', NULL , array('class' => 'form-control', 'placeholder' => trans('messages.create_page_placeholder') ))); ?>

					<?php else: ?>
						<?php echo e(Form::textarea('description', $staticPage->description , array('class' => 'form-control', 'placeholder' => trans('messages.create_page_placeholder') ))); ?>
