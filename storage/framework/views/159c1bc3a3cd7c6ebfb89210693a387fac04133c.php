	...
	<div class="panel-body">
		...
		<form class="socialite-form" method="POST" action="<?php echo e(url('admin/groups/'.$username.'/edit')); ?>">
			...
			<fieldset class="form-group">
				...
				<input type="text" name="username" class="form-control content-form" placeholder="<?php echo e(trans('admin.username_placeholder')); ?>"  value="<?php echo e($timeline->username); ?>" disabled>
